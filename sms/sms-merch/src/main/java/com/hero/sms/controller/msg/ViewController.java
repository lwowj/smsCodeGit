...
public class ViewController extends BaseController {
    ...
    public String messageAdd(Model model){
        getMessageTypeFilterSystem(model);
    ...
    private void getMessage(Model model, Integer id){
        model.addAttribute("msg", messageService.findMessages(id,getCurrentUser().getUserAccount()));
    }
    ...
    private void getMessageTypeFilterSystem(Model model){
        model.addAttribute("messageType", MessageTypeEnums.filterSystemType());
        model.addAttribute("readStatus", MessageReadStatusEnums.values());
    }
