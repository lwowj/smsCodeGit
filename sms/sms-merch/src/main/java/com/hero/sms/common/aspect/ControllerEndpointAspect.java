    ...
    public Object around(ProceedingJoinPoint point) throws FebsException {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(operation)) {
                ...
                // 设置操作用户
                OrganizationUserExt user = (OrganizationUserExt) SecurityUtils.getSubject().getPrincipal();
                organizationLogService.saveLog(point, targetMethod, ip, operation, start,user);
            }
            return result;
        } 
