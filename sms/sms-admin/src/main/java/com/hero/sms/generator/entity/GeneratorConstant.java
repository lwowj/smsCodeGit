...
public class GeneratorConstant {
     ...
     * 数据库名称
     */
    public static final String DATABASE_NAME = "bfsms_base";
     ...
     * list html 文件类型后缀
     */
    public static final String LIST_HTML_FILE_SUFFIX = ".html";

    /**
     * add html 文件类型后缀
     */
    public static final String ADD_HTML_FILE_SUFFIX = "Add.html";

    /**
     * update html 文件类型后缀
     */
    public static final String UPDATE_HTML_FILE_SUFFIX = "Update.html";
     ...
     * list html 模板
     */
    public static final String LIST_HTML_TEMPLATE = "list.ftl";

    /**
     * add html 模板
     */
    public static final String ADD_HTML_TEMPLATE = "add.ftl";

    /**
     * update html模板
     */
    public static final String UPDATE_HTML_TEMPLATE = "update.ftl";
}
